...
- Create Angular project with ng: `ng new angular_and_core_api.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angular_and_core_api.client.esproj`).
